...
import java.util.Date;
  ...
  class Info{
    ...
    String message;
     ...
     Info(Date date,String senderId,String message){
        this.date = date;
...
public class Gmail extends Email {
    ...
    public ArrayList<Info> inbox;
    public ArrayList<Info> trash;
    ...
    public void receiveMail(Date date, String sender, String message){
        ...
        if(inbox.size()==inboxCapacity){
            Info firstMail = inbox.get(0);//remove first mail
            inbox.remove(0);
            trash.add(firstMail);
        }
        Info newMail = new Info(date,sender,message);
        inbox.add(newMail);
    }
